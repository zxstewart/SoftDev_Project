...
x = PrettyTable([line_1[8],line_1[9],line_1[2],line_1[4],line_1[5],line_1[10],line_1[3],line_1[12]])

for a in range(1,17173):
    line = csv_file[a]
    line = line.split(',')
    x.add_row([line[8],line[9],line[2],line[4],line[5],line[10],line[3],line[12]])
